                      ...
                      <div className="letter" ref={letterRef}>
                          <div className="body">
                              ...
                              <div className="message">
                                  <p>Selamat Natal dan Tahun Baru 2025! Semoga kedamaian dan kebahagiaan selalu
                                      ...
                                      warna baru dalam hidupku yang tak pernah kubayangkan sebelumnya.</p>
                                  <div className="my-3"></div>
                                  <p>Memasuki tahun yang baru, aku berharap kita terus tumbuh bersama, belajar dari
                                      ...
                                      banyak kenangan indah yang akan kita kenang bersama, happy 20 month anniv!, i love u from fwz.</p>
                              </div>
                          </div>
                      </div>
                  </div>
